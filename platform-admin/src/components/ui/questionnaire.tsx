...
function QuestionnaireDescription({
  ...
  return (
    <QuestionnairePrimitive.Description
      ...
      className={cn("text-[14px] text-pretty text-muted-foreground", className)}
      {...props}
    />
  );
}
...
function QuestionnaireChoice({
  ...
  return (
    <QuestionnairePrimitive.Choice
      ...
      className={cn(
        "group/questionnaire-choice relative flex min-h-11 cursor-pointer items-start gap-2.5 rounded-lg border border-input bg-transparent px-3 py-2.5 text-start text-[14px] transition-colors outline-none select-none hover:bg-muted/50 has-[>input:focus-visible]:border-ring has-[>input:focus-visible]:ring-3 has-[>input:focus-visible]:ring-ring/50 data-invalid:border-destructive dark:bg-input/20 data-checked:border-primary/40 data-checked:bg-muted dark:data-checked:bg-muted",
...
function QuestionnaireError({
  ...
  return (
    <QuestionnairePrimitive.Error
      ...
      className={cn("mt-2 text-[14px] text-destructive", className)}
      {...props}
    />
  );
}
